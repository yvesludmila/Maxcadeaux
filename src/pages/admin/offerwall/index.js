...
export default function ValidationAdmin() {
    ...
    async function getAllValidation() {
        await axios.get(`/api/offerwall/all`).then(async (res) => {
            if (res.status == 200) {
                    ...
                    <div className="row">
                        <div
                            ...
                            <h3 className="text-black ">
                                Administration de mission Offerwall
                            </h3>
                            <div>
                                <button
                                          ...
                                          Le {val.dateHisto}
                                                                    ...
                                                                    <td className="py-3 px-6 text-left">
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                className="text-[11px] ml-2 font-light">
                                          {' '}
                                                                                {val.ipMision}
                                        </span>
                                                                        </div>
