...
export default function NouveauMission() {
    ...
    function addMoreUrlOffer() {
        const urls = newOffer.url;
        // const urls = "https://kkk.com,https://k2k.com";
        ...
        setNewOffer({ ...newOffer, url: value });
    }
            ...
            <div className="container">
                <div className="row">
                  ...
                  <div className="form-group mb-4 text-black">
                    ...
                    <input
                      onChange={(e) => {
                        setNewOffer({ ...newOffer, url: e.target.value });
                      }}
                      value={newOffer.url}
                      required
                      type="text"
                    ...
                    />
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group mb-4 text-black">
                                        <label>Description de l'offre (Longue)</label>
                                        <textarea
                                            onChange={(e) => {
                                                setNewOffer({
                                                    ...newOffer,
                                            ...
                                            type="text"
                                            className="form-control border-yellow-400 text-black border-2 py-2"
