                                        ...
                                        <div className="card-body">
                                            <form action="#">
                                                <div className="form-group">
                                                    ...
                                                    <ul className="crypto_currencies">
                                                        <li className="wave-effect active"><i className="cc BTC-alt"
                                                                                              title="BTC"></i>
                                                            Bitcoin
                                                        </li>
                                                        <li className="wave-effect"><i className="cc LTC"
                                                                                       title="BTC"></i> Litecoin
                                                        </li>
                                                        <li className="wave-effect"><i className="cc ETH"
                                                                                       title="BTC"></i> Etherum
                                                        </li>
                                                        <li className="wave-effect"><i className="cc BTC"
                                                                                       title="BTC"></i>Bitcoin Cash
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div className="form-group">
